...
public interface EntityIndexService {
	 ...
	 */
	public List<ScoreDoc> query(Set<AbsoluteCodingSchemeVersionReference> codingSchemes, List<? extends Query> combinedQueries, List<? extends Query> individualQueries);
